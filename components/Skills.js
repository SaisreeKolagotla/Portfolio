          ...
          {skills.map((group, gi) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-bold text-lg" style={{ color: 'var(--fg)' }}>{group.category}</h3>
              </div>
                ...
                {group.items.map((skill, si) => (
                  <div key={skill.name}>
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="text-xs font-mono" style={{ color: 'var(--brand)' }}>{skill.level}%</span>
                    </div>
                    {/* Progress bar */}
                    <div
                    ...
                    >
                      <motion.div
                        ...
                        transition={{ duration: 1, delay: gi * 0.15 + si * 0.08 + 0.3 }}
                      />
                    </div>
                  </div>
                ))}
